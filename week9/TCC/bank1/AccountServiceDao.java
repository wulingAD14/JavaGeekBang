...
public interface AccountServiceDao {
    ...
    int subtractAccountUSDBalance(@Param("accountNo") String accountNo, @Param("amount") Double amount);
    @Update("update account_info set RMB_balance=RMB_balance + #{amount}*7 where account_no=#{accountNo} ")
    int addAccountRMBBalance(@Param("accountNo") String accountNo, @Param("amount") Double amount);
